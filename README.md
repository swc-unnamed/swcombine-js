...
| Revoke privilege from character            | :white_check_mark: | OAuth :lock:     | character_privileges, and must be logged in as someone that can grant/revoke privileges of others.         |
| **<h3>Datacard</h3>**                      | :x:                |                  |                                                                                                            |
